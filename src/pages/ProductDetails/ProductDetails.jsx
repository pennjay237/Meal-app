...
const ProductDetails = () => {
  ...
  // Calculate nutritional info (simulated)
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.info}>
          ...
          <p className={styles.category}>{currentMeal.strCategory} • {currentMeal.strArea}</p>
          <p className={styles.price}>${Math.floor(Math.random() * 50) + 10}</p>
        </div>
      </div>
